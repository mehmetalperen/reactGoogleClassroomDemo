...
function NewComment(){
    ...
    return(
        ...
        !isBoxClicked?
         <div className="preview-box" onClick={()=> {setIsBoxClicked(!isBoxClicked)}}><img src="./imgFolder/logo192.png" alt="PP"/><p>Share something with your class..</p></div>:
        ...
        <div className="comment-box">
            ...
            <div className="viewer-select-btn">
                ...
                <InputGroup size="lg">
                    ...
                    <FormControl as="textarea" aria-label="With textarea" placeholder="Share with your class" rows={5}/>
                </InputGroup>
                </div>
